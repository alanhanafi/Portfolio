...
export default [
    /*new ProjectData("project-7", "Game Tools", "img/projects/project-7-icon.png", `
    <div class="paragraph">
            ...
            <div class="paragraph center">
                ...
                <img class="pc-screenshot" src="https://fakeimg.pl/534x300/" alt="Drew Blood Screenshot" />
                <img class="pc-screenshot" src="https://fakeimg.pl/534x300/" alt="Drew Blood Screenshot" /> 
            </div>`, "#1ca1e2", true, true),*/
    new ProjectData("project-6", "Professional Esports Player", "img/projects/project-6-icon.png", `
    <div class="paragraph">
